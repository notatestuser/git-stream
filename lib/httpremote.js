...
var HttpRemote = module.exports = function HttpRemote(repo, name, repoUrl) {
  
  Remote.apply(this, [repo, name, repoUrl]);
...
HttpRemote.prototype.parseInfoRefs = function(data) {
...
HttpRemote.prototype.parsePackList = function(data) {
  var lines = data.split("\n")
  var packs = []
  _(lines).each(function(line) {
    if (line !== "") {
...
HttpRemote.prototype.parseObjectData = function(sha, compressedData) {
  var deflated = Git.stripZlibHeader(Git.stringToBytes(compressedData))
  var data = new Buffer(RawDeflate.inflate(Git.bytesToString(deflated)).toString())
  var offset = 0
