...
var SmartHttpRemote = module.exports = function(repo, name, repoUrl) {

  Remote.apply(this, [repo, name, repoUrl])
  
  //
  // TO replace this stuff with FS.
  //
...
SmartHttpRemote.prototype.parseDiscovery = function(data) {
...
//
// Returns a String
SmartHttpRemote.prototype.refWantRequest = function(wantRef, haveRefs) {
