...
module.exports = {
  ...
  "unpack: parses out objects": function(t) {
    t.plan(1);
    repo.getPackFile(function(err, obj) {
      var packFile = new git.Pack(obj.buffer);
      packFile.parseAll();
console.log(obj.totalObjects)
      t.equal(packFile.getObjects().length, obj.totalObjects);
      t.end()
    });
  },
/*
